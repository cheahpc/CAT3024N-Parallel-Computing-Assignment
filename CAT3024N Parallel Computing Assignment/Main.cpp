...
std::vector<float> updateHistogramData(Temperature data);
...
int main(int argc, char** argv)
{
	...
	std::vector<string>& stationName = data.GetName();
	...
	try
	{
		...
		while (true) {
			...
			switch (choice) {
				case 1:
					std::cout << "NOTE: RUNNING ON SERIAL MODE" << endl << endl;
					Serial(temps);
				...
				case 2:
					...
					break;
				case 3:
					std::cout << "NOTE: RUNNING ON PARALLEL MODE" << endl << endl;
...
void displayMenu() 
{
	...
	std::cout << "Student Name	: A SAMPLE WORK FOR YOUR UNDERSTANDING " << endl;
	std::cout << "Student ID	: 1234" << endl;
	std::cout << "CAT3024 Parallel Computing - Assignment" << endl << endl;

	std::cout << "------------------------------" << std::endl;
	std::cout << "     PARALLEL ASSIGNMENT      " << std::endl;
	std::cout << "------------------------------" << std::endl;
	std::cout << "SERIAL mode: " << std::endl;
	std::cout << "1. Statistic Summary" << std::endl;
	std::cout << "2. Histogram Summary" << std::endl;
	std::cout << std::endl;
	std::cout << "PARALLEL mode: " << std::endl;
	std::cout << "3. Statistic Summary" << std::endl;
	std::cout << "4. Histogram Summary" << std::endl;
	std::cout << std::endl;
...
{
	//Display
	if (displayType) { // if is summary data
...
void Serial_Summary(std::vector<float>& temp, std::vector<string>& stationName, std::vector<int>& month) {
	...
	std::cout << std::endl;
	std::cout << "TOTAL COMPLETION TIME: \t" << (endTime - startTime) << " ms" << std::endl << std::endl << std::endl;;
